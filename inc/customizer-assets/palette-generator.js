const palette_generator_html = `
        ...
        <a class="button style-guide-link" href="#website">${theStyleGuideIcon}View Style Guide</a>
...
(function ($) {
  $(document).ready(function () {
    ...
    document
      .getElementById("color_type_select")
      .addEventListener("change", function () {
        const colorSelector = document.getElementById("color_selection");
        if (this.value == "None") colorSelector.style.display = "none";
        else colorSelector.style.display = "block";
      });
    ...
    $("body").on("click", ".result-palettes > DIV", function (e) {
      ...
      setColorWidget(
        "body-color",
        $(this).find("> DIV:eq(1)").attr("data-color")
      );
