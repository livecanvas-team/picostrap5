(function ($) {
    ...
    $(document).ready(function () {
        ...
        pico_add_to_customizer("section-typography", "<a class='button style-guide-link' href='#typography'     >" + theStyleGuideIcon + "Style Guide</a> <a class='button' href='#' id='cs-show-combi'>Font Combinations...</a>");
