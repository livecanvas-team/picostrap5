...
function picostrap_customize_enqueue() {
	...
	wp_enqueue_script( 'custom-customize-lib', get_template_directory_uri() . '/inc/customizer-assets/customizer-constants.js', array( 'jquery', 'customize-controls','customize-preview' ), rand(0,1000), true );
