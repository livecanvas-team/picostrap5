...
if(!function_exists('picostrap_the_sharing_buttons')):
	function picostrap_the_sharing_buttons(){
		...
		<div class="picostrap-sharing-buttons mt-4 mb-5" >
			...
			<!-- X (url, text, @mention) -->
			<a class="btn btn-outline-dark  btn-sm btn-x" href="https://x.com/intent/tweet?url=<?php echo $url_to_share ?>&text=<?php echo esc_attr(get_the_title()) ?>&via=<?php echo get_the_author_meta( 'twitter', get_the_author_meta( 'ID' ) ) ?>" target="_blank" rel="nofollow" title="Share on X">
